...
df.write.format("mongodb") \
    .option("spark.mongodb.write.connection.uri", "mongodb://adminuser:password123@mongo-nodeport-svc.mongodb/") \
...
df_loaded = spark.read.format("mongodb") \
    .option("spark.mongodb.read.connection.uri", "mongodb://adminuser:password123@mongo-nodeport-svc.mongodb/") \
